...
export const getServerSideProps = async (context) => {
  ...
  const posts = await fetch(
    `http://localhost/wordpress/mysite/wp-json/wp/v2/posts/${params.postID}`
  ).then((res) => res.json());
              ...
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <span className="rating">
                    ...
                    <em>4.00/5.00 - based on 234 reviews</em>
                  </span>
                </div>
          ...
          <div className="row">
            ...
            <div className="col-lg-4">
              <div className="box_general company_info">
                ...
                <p>
                  Illud scripserit mei an, sea te sonet partem contentiones. Eu
                  quo corrumpit euripidis, enim sadipscing eos an. Mucius doctus
                  constituto pri at, ne cetero postulant pro. At vix utinam
